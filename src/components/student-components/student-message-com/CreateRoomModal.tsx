        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-[#0c2d48] focus:border-transparent"
          ...
          <div>
            ...
            {fetchingM ? (
              <div className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 flex items-center gap-2 text-sm text-gray-400">
                <span className="w-4 h-4 border-2 border-[#0c2d48] border-t-transparent rounded-full animate-spin" />
                Loading…
              </div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-[#0c2d48] cursor-pointer"
              >
