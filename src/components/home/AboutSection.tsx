              ...
              return (
                <div key={idx} className="flex items-start gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-[15px] sm:text-[18px] md:text-xl font-bold text-gray-900">
                      {stat.value}
                    </div>
          ...
          <div className="flex-1 min-h-[160px] sm:min-h-[180px] md:min-h-[200px] lg:min-h-[280px] xl:min-h-[320px]">
            {images[0] ? (
              <img
                src={images[0]}
                alt="about-primary"
                className="w-full h-full object-cover object-[25%]  rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-[32px]"
              />
            ) : (
              <div className="w-full h-full min-h-[160px] sm:min-h-[180px] md:min-h-[200px] lg:min-h-[280px] xl:h-[300px] bg-gray-200 rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-[32px]" />
            )}
          </div>
          ...
          <div className="flex-1 flex flex-col">
            <div className="flex-1 lg:flex items-center justify-center hidden">
              {images[1] ? (
                ...
                <div className="aspect-square rounded-full border-2 sm:border-[3px] md:border-4 border-dashed border-[#e4a918] bg-white" />
              )}
            </div>

            <div className="flex-1 min-h-[120px] sm:min-h-[130px] md:min-h-[200px] lg:min-h-[150px] hidden sm:flex">
              {images[2] ? (
                <img
                  src={images[2]}
                  alt="about-tertiary"
                  className="w-full h-full object-cover rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-[24px]"
                />
              ) : (
                <div className="w-full h-full bg-gray-200 rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-[24px]" />
              )}
            </div>
          </div>
