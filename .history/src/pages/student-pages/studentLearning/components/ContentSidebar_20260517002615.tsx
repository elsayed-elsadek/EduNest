  ...
  return (
    <aside className="w-full lg:w-[350px] flex-shrink-0">
      ...
      <div className="lg:sticky lg:top-24 space-y-4">
        ...
        <Link
          to={`/mentorships/${mentorshipId}`}
          className="m-[70px] text-white px-4 py-2.5 mt-4 text-center text-sm rounded-full bg-[var(--primary-500)] hover:bg-[var(--primary-dark)] transition-colors duration-200 block"
        >
